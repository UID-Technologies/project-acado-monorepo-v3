...
import PostCardView from './CardView';
import ShareData from './ShareData';
import { usePostsStore } from '@app/store/common/postStore';
...
const CommunityDetails: React.FC = () => {
  ...
  if (members?.data?.admin) {
    filteredMembers.push(...members.data.admin.map((member: any) => ({
      ...member,
      role: 'admin' as const,
    })));
  }
      ...
      <div className="w-full flex flex-col md:flex-row py-6 gap-5">
        <div className="w-full md:w-[75%]">
          <div className="mt-4">
            ...
            <div className="rounded-lg overflow-hidden bg-white dark:bg-dark shadow-sm mb-6 border p-3">
              <div
                  ...
                  <div className="flex -space-x-2">
                    {filteredMembers.slice(0, 4).map((member) => (
                      <img
                        ...
                        alt={member.name}
                        className="w-8 h-8 rounded-full object-cover border-2 border-white dark:border-black cursor-pointer"
                      />
                    ))}
                    <div className="w-8 h-8 rounded-full bg-gray-200 flex items-center justify-center border-2 border-white dark:border-black text-xs text-gray-600 cursor-pointer">
                      +
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
            ...
            <div className="bg-white dark:bg-black rounded-lg shadow-sm mb-6">
        ...
        <div className="w-full md:w-[25%]">
          <div className="sticky top-24 space-y-5">
            <div className="bg-white dark:bg-black rounded-xl p-4 shadow-sm border glowConnectCard">
              <div className="mb-4">
