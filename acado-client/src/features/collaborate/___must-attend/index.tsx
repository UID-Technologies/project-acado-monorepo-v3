...
type ResourceCategory = "Community Meetup" | "Flagship Events" | "Internship Placement Drive";
...
const Mustattenddetail = () => {
    ...
    const [activeTab, setActiveTab] = useState<ResourceCategory>("Community Meetup");
    ...
    useEffect(() => {
        ...
        if (eventCategory) {
            setActiveTab(eventCategory || "Community Meetup");
        }
    }, [eventCategory]);
    ...
    return (
        <div>
            <Heading title='Must Attend' description='High-priority flagship events and community gatherings across India' />
