...
import { Dribbble, Expand, Globe, Instagram, Link2, Phone, Trash, X } from 'lucide-react';
...
function index() {
    ...
    const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files[0]) {
            ...
            fetchUpdateImage(uploadedImage).then(() => {
        ...
        <>
            <Tabs defaultValue="personal" value={tab} onValueChange={setTab}>
                <div className='flex justify-between gap-4'>
                    ...
                    <Link to='/portfolio'>
                        <Button className='text-white dark:text-black'>Preview Portfolio</Button>
                    </Link>
                </div>
                        ...
                        <CardContent>
                            <div className="flex items-center gap-5 mt-2">
                                <div className="relative w-20 h-20 group">
                                    ...
                                    <button
                                        className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 text-white dark:text-black text-sm rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
                            ...
                            {portfolio?.portfolio_profile?.length !== 0 && <table className='w-full mt-3'>
                                <tbody className='divide-y'>
                                    <tr className=''>
                                        <td className='font-semibold p-3 text-gray-600'>Full Name</td>
                                        <td>{portfolio?.portfolio_profile[0].name} {portfolio?.portfolio_profile[0].lastName}</td>
                                    </tr>
                                    <tr className=''>
                                        <td className='font-semibold p-3 text-gray-600'>Email</td>
                                        <td>{portfolio?.portfolio_profile[0].email}</td>
                                    </tr>
                                    <tr className=''>
                                        <td className='font-semibold p-3 text-gray-600'>Phone Number</td>
                                        <td>{portfolio?.portfolio_profile[0].phone}</td>
                                    </tr>
                                    <tr className=''>
                                        <td className='font-semibold p-3 text-gray-600'>Address</td>
                                        <td>
                                            {portfolio?.portfolio_profile[0].city}, {portfolio?.portfolio_profile[0].state}, {portfolio?.portfolio_profile[0].country}
                                        </td>
                                    </tr>
                                    <tr className=''>
                                        <td className='font-semibold p-3 text-gray-600'>About</td>
                                        <td>{portfolio?.portfolio_profile[0].about_me}</td>
                                    </tr>
                                </tbody>
                            </table>
                            }
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                                {portfolio?.portfolio_social[0].linkedin && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                ...
                                {portfolio?.portfolio_social[0].facebook && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                ...
                                {portfolio?.portfolio_social[0].twitter && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                ...
                                {portfolio?.portfolio_social[0].insta && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                ...
                                {/* gmail */}
                                {portfolio?.portfolio_social[0].email && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                ...
                                {/* phone number */}
                                {portfolio?.portfolio_social[0].mob_num && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                    <div className='w-12 h-12 object-contain rounded-lg flex justify-center items-center bg-gray-300'>
                                        <Phone size={40} />
                                    </div>
                                    <div>
                                ...
                                {/* website */}
                                {portfolio?.portfolio_social[0].site_url && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                    <div className='w-12 h-12 object-contain rounded-lg flex justify-center items-center bg-gray-300'>
                                        <Globe size={40} />
                                    </div>
                                    <div>
                                ...
                                {/* Dribbble */}
                                {portfolio?.portfolio_social[0].dribble && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                                    <div className='w-12 h-12 object-contain rounded-lg flex justify-center items-center bg-gray-300'>
                                        <Dribbble size={40} />
                                    </div>
                                    <div>
                                ...
                                {/* pinterest */}
                                {portfolio?.portfolio_social[0].pinterest && <div className='flex bg-gray-200 dark:bg-gray-900 items-center gap-4 border p-4 rounded-lg'>
                            ...
                            <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                                {
                                    portfolio.Education.map((education, index) => (
                                        <Card key={index}>
                                            ...
                                            <CardContent>
                                                <p className='text-gray-500'>{education.start_date} - {education.end_date}</p>
                                    ...
                                    portfolio?.Project && portfolio?.Project?.map((project, index) => (
                                        <Card key={index}>
                                            ...
                                            <CardContent>
                                                ...
                                                <p className='text-gray-500 mt-2'>{project.start_date} - {project.end_date || 'Present'}</p>
                                            </CardContent>
                                            <CardFooter>
