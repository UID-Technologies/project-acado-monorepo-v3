...
import { Link2, MapPin, Phone, Twitter } from 'lucide-react'
...
const Portfolio: React.FC = () => {
    ...
    const { setPortfolio, portfolio, setError, loading, setLoading } =
        usePortfolioStore()
        ...
        <>
            <div className="min-h-screen">
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://public.readdy.ai/ai/img_res/13b14f3c10dc89b08518e138645fb430.jpg')`,
                    }}
                >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-32 relative z-10">
                    <div className="bg-ac-dark rounded-lg shadow border p-8">
                        <div className="flex flex-col md:flex-row items-center">
                            <div className="relative">
                                <img
                                    src={
                                        portfolio?.image
                                            ? portfolio?.image?.replace(
                                                  '/https:',
                                                  'https:',
                                              )
                                            : deafultprofile
                            ...
                            {Array.isArray(portfolio?.portfolio_profile) &&
                            ...
                            <div className="ml-auto mt-4 md:mt-0 flex gap-2">
                                <Link
                                    to="/portfolio/edit"
                                    className="rounded bg-primary  text-white dark:text-black px-6 py-2 flex items-center space-x-2 hover:bg-primary-deep transition duration-200"
                                >
                    ...
                    <div className="mt-8 space-y-8">
                        <div className="bg-ac-dark rounded-lg shadow border p-8">
                            ...
                            {Array.isArray(portfolio?.portfolio_profile) &&
                                portfolio?.portfolio_profile?.length === 0 && (
                                    <p className="text-gray-500">
                                        No data found. Please update your
                                        profile.
                                    </p>
                                )}
                        </div>
                                    ...
                                    <div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            {portfolio?.skill?.map((skill) => (
                                                <div
                                                    key={skill?.name}
                                                    className="bg-gray-200 dark:bg-gray-950 border border-gray-50 dark:border-gray-800 p-4 rounded-lg"
                                                >
                                    ...
                                    <div className="space-y-6">
                                        {portfolio?.Experience?.map(
                                            (experience, index) => (
                                                <div
                                                    key={`exp` + index}
                                                    className="bg-gray-200 dark:bg-gray-950 p-6 rounded-lg border border-gray-50 dark:border-gray-800"
                                                >
                                        ...
                                        {portfolio?.Certificate &&
                                            portfolio?.Certificate?.map(
                                                (Certificates, index) => (
                                                    <div
                                                        key={`project-${index}`}
                                                        className="bg-gray-200 dark:bg-gray-950 rounded-lg border border-gray-50 dark:border-gray-800 overflow-hidden"
                                                    >
                                                        {Certificates?.image_name &&
                                                            getFileType(
                                                                Certificates?.image_name,
                                                            ) === 'pdf' && (
                                                                <embed
                                                                    src={`https://elms.edulystventures.com/portfolio/${Certificates.image_name}`}
