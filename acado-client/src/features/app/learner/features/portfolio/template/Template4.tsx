  ...
  return (
    <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm font-serif">
      ...
      <div className="bg-[#4A7C6F] text-white p-8 rounded-t-lg text-center">
        ...
        <h1 style={{ color: "black"}} className="text-5xl font-light mb-4 text-white">{portfolio?.name}</h1>
      ...
      <div className="p-8 space-y-6">
        {/* Summary Section */}
        <section>
          <h2 style={{ color: "black"}} className="text-[#4A7C6F] text-xl font-semibold mb-3 border-b border-[#4A7C6F]/20">Summary</h2>
        ...
        {/* Skills Section */}
        <section>
          <h2 style={{ color: "black"}} className="text-[#4A7C6F] text-xl font-semibold mb-3 border-b border-[#4A7C6F]/20">Skills</h2>
        ...
        {/* Experience Section */}
        <section>
          <h2 style={{ color: "black"}} className="text-[#4A7C6F] text-xl font-semibold mb-3 border-b border-[#4A7C6F]/20">Experience</h2>
          <div className="space-y-6">
            {Array.isArray(portfolio.Experience) &&
              portfolio?.Experience.map((experience, index) => (
                <div key={index}>
                  <div className="mb-2">
                    <h3 style={{ color: "black"}} className="font-semibold uppercase text-gray-900">
        ...
        {/* Education Section */}
        <section>
          <h2 style={{ color: "black"}} className="text-[#4A7C6F] text-xl font-semibold mb-3 border-b border-[#4A7C6F]/20">
            Education and Training
          </h2>
          {Array.isArray(portfolio.Education) &&
            portfolio?.Education.map((education, index) => (
              <div key={index} className="mb-4">
                <h3 style={{ color: "black"}} className="font-semibold text-gray-900">{education.institute}</h3>
        ...
        {portfolio?.Certificate && portfolio?.Certificate.length > 0 && (
          <section>
            <h2 style={{ color: "black"}} className="text-[#4A7C6F] text-xl font-semibold mb-3 border-b border-[#4A7C6F]/20">Certifications</h2>
            {Array.isArray(portfolio.Certificate) &&
              portfolio?.Certificate.map((certificate, index) => (
                <div key={index} className="mb-4">
                  <h3 style={{ color: "black"}} className="font-semibold text-gray-900">{certificate.title}</h3>
