                            ...
                            <Controller
                                ...
                                render={({ field }) => (
                                    <Input
                                        ...
                                        {...field}
                                        value={
                                            field.value ? new Date(new Date(field.value).getTime() - new Date(field.value).getTimezoneOffset() * 60000,
                                        ...
                                        onChange={(e) => {
                                            ...
                                            if (!isNaN(date.getTime())) {
                                                ...
                                                field.onChange(null); // or handle invalid date however you prefer
                                            }
                                        }}
                                    />
                                )}
