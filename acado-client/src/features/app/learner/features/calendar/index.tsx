...
const Calendar: React.FC = () => {
    ...
    const handleAddEvent = async (newEvent: Omit<Event, 'id'>) => {
        ...
        try {
            ...
            if (addedEvent) {
                toast.success('Event added successfully', { id: toastId }) // Update toast on success
    ...
    const handleEditEvent = (updatedEvent: Omit<Event, 'id'>) => {
        setShowModal(false)
    }
    ...
    return (
        <div className="bg-white dark:bg-gray-800 p-4 rounded shadow-md w-full max-w-7xl mx-auto overflow-hidden">
            ...
            {/* Calendar Wrapper */}
            <div className="h-[calc(100vh-10rem)] sm:h-[80vh] min-h-[500px] overflow-x-auto dark:bg-gray-900">
                <BigCalendar
                    events={events}
                    step={60}
