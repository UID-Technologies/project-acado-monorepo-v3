                ...
                <div className="absolute w-[95%] bottom-[-50%] md:bottom-[-15%] bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                    ...
                    <div className="md:flex">
                        ...
                        <div className="w-full px-5 py-3">
                            ...
                            <div className="text-gray-700 dark:text-gray-400 line-clamp-5"
                            ...
                            {/* <Link to={`/volunteering-activity/${program_id}`} className="bg-primary text-white dark:text-gray-900 font-bold py-2 px-6 rounded hover:bg-primary-light dark:hover:bg-primary-dark transition">
                                Join Now
                            </Link> */}
                        </div>
                    </div>
