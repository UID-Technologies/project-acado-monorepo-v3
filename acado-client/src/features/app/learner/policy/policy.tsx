      ...
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        <div className="space-y-8">
          ...
          <div className="text-center bg-white dark:bg-gray-700 rounded-lg p-8 shadow-sm">
            <h1 className="text-4xl font-bold mb-4 dark:text-primary text-primary">Privacy Policy</h1>
          ...
          <div className="bg-white dark:bg-gray-700 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow">
            <p className="text-lg leading-relaxed">
              Acado is committed to protecting the privacy of our users. This Privacy Policy explains how we collect,
