...
const Queries = () => {
    ...
    return (
        <div >
            ...
            >
                <div className="flex items-center justify-between mb-4 border-b-2 border-gray-200 dark:border-gray-700">
                    <TabsList>
                        <TabsTrigger value="my">My Queries</TabsTrigger>
                        <TabsTrigger value="draft">Draft Queries</TabsTrigger>
                    </TabsList>
                    <div className='flex items-center mb-1'>
                        <Button asChild className='mr-2 dark:text-black text-white'>
                            <Link to="/help/mail-box/new">
                                New Query
                            </Link>
                        </Button>
                    </div>
