...
import Content from "../../learner/volunteering/Content";


const SchlorshipActivity: React.FC = () => {
    ...
    const showContentDetails = (content: ContentData) => {
        navigate(`/schlorship-activity/${id}/content/${content.id}`)
    }
    ...
    return (
        <>
            <div className="flex gap-3 justify-start items-center">
                <Link to="/learner-scholarship" className="text-primary dark:text-primary">
                    <ArrowLeft size={30} />
                </Link>
                <h1 className="text-3xl font-bold text-start dark:text-primary text-primary">Schlorship Activity</h1>
            </div>
                    ...
                    <div className="flex-1 p-4 space-y-4 border-l border-gray-200 dark:border-gray-700 dark:bg-gray-900 bg-white opacity-90">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-lg text-white font-medium ${hasApplied
                                ? "bg-green-500 hover:bg-green-600 dark:text-ac-dark"
                                : applying
                                    ? "bg-gray-400 cursor-not-allowed dark:text-ac-dark"
                                    : "bg-primary hover:bg-primary/90 dark:text-ac-dark"
                                }`}
                        >
                            {jobStatus ?? "Apply Now"}
                        </button>
...
export default SchlorshipActivity
